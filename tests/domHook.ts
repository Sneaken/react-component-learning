...
export function spyElementPrototypes<T extends ElementClass>(elementClass: T, properties: Record<string, Property>) {
  const propNames = Object.keys(properties);
  const originDescriptors = {} as any;
  ...
  propNames.forEach((propName) => {
    ...
    const spyProp = properties[propName] as any;
